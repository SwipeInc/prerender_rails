  ...
  class Prerender
    ...
    def build_api_url(env)
      ...
      if env["CF-VISITOR"]
        ...
        new_env["HTTPS"] = "on" and new_env["X_FORWARDED_SSL"] = "on" and new_env["X_FORWARDED_SCHEME"] = "https" and new_env["HTTP_X_FORWARDED_PROTO"] = "https" and new_env["X_FORWARDED_PROTO"] = "https" and new_env["HTTP_X_FORWARDED_PORT"] = 443 and new_env["X_FORWARDED_PORT"] = 443 and new_env["rack.url_scheme"] = "https" and new_env["SERVER_PORT"] = 443 if (match && match[1] == "https")
      ...
      if env["X-FORWARDED-PROTO"]
        new_env["HTTPS"] = "on" and new_env["X_FORWARDED_SSL"] = "on" and new_env["X_FORWARDED_SCHEME"] = "https" and new_env["HTTP_X_FORWARDED_PROTO"] = "https" and new_env["X_FORWARDED_PROTO"] = "https" and new_env["HTTP_X_FORWARDED_PORT"] = 443 and new_env["X_FORWARDED_PORT"] = 443 and new_env["rack.url_scheme"] = "https" and new_env["SERVER_PORT"] = 443 if env["X-FORWARDED-PROTO"].split(',')[0] == "https"
      ...
      if @options[:protocol]
        ...
        new_env["HTTPS"] = "on" and new_env["X_FORWARDED_SSL"] = "on" and new_env["X_FORWARDED_SCHEME"] = "https" and new_env["HTTP_X_FORWARDED_PROTO"] = "https" and new_env["X_FORWARDED_PROTO"] = "https" and new_env["HTTP_X_FORWARDED_PORT"] = 443 and new_env["X_FORWARDED_PORT"] = 443 and new_env["rack.url_scheme"] = "https" and new_env["SERVER_PORT"] = 443 if @options[:protocol] == "https"
